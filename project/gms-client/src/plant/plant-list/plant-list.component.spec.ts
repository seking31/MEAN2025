...
describe('PlantListComponent', () => {
  ...
  it('should display records in the DOM', () => {
    ...
    const plantRows = fixture.debugElement.queryAll(
      By.css('.plant-page__table-body .plant-page__table-row')
    );
  });
  ...
  it('should delete a plant', () => {
    ...
    expect(deletePlantfunction).toHaveBeenCalled;
  });
});
